...
class CreateRodiniaTables extends Migration {
    ...
    public function up() {
        ...
        Schema::create('horses', function (Blueprint $table) {
            ...
            $table->integer('speed')->nullable()->default(50); 
            $table->integer('staying')->nullable()->default(50); 
            $table->integer('stamina')->nullable()->default(50); 
            $table->integer('breaking')->nullable()->default(50); 
            $table->integer('power')->nullable()->default(50); 
            $table->integer('feel')->nullable()->default(50); 
            $table->integer('fierce')->nullable()->default(50); 
            $table->integer('tenacity')->nullable()->default(50); 
            $table->integer('courage')->nullable()->default(50); 
            $table->integer('response')->nullable()->default(50); 
            ...
            $table->string('bandages')->nullable()->default('None');
            $table->string('neck_height')->nullable()->default('Normal');
            $table->string('run_style')->nullable()->default('Normal'); 
            $table->string('hood')->nullable()->default('No'); 
            $table->string('shadow_roll')->nullable()->default('No'); 
            $table->timestamps();
        });

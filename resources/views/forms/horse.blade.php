  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="panel panel-default">
        ...
        <div class="text-right">If person not in list, <a href="/quick-person" type="button" class="btn btn-primary btn-xs" data-remote="false" data-toggle="modal" data-target="#quick-form" >
          Add Person 
        </a></div>
      </div><!--end panel-body-->
    </div><!--end panel-->
...
<div class="col-md-4">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <div class="form-group">
        <label for="speed" class="col-sm-2 col-md-4 control-label">Speed</label>
      ...
      <div class="form-group">
        <label for="staying" class="col-sm-2 col-md-4 control-label">Staying</label>
        <div class="col-sm-10 col-md-8">       
      ...
      <div class="form-group">
        <label for="stamina" class="col-sm-2 col-md-4 control-label">Stamina</label>
        <div class="col-sm-10 col-md-8">       
      ...
      <div class="form-group">
        <label for="breaking" class="col-sm-2 col-md-4 control-label">Breaking</label>
        <div class="col-sm-10 col-md-8">       
      ...
      <div class="form-group">
        <label for="power" class="col-sm-2 col-md-4 control-label">Power</label>
        <div class="col-sm-10 col-md-8">       
      ...
      <div class="form-group">
        <label for="feel" class="col-sm-2 col-md-4 control-label">Feel</label>
        <div class="col-sm-10 col-md-8">       
      ...
      <div class="form-group">
        <label for="fierce" class="col-sm-2 col-md-4 control-label">Fierce</label>
        <div class="col-sm-10 col-md-8">       
      ...
      <div class="form-group">
        <label for="tenacity" class="col-sm-2 col-md-4 control-label">Tenacity</label>
        <div class="col-sm-10 col-md-8">       
      ...
      <div class="form-group">
        <label for="courage" class="col-sm-2 col-md-4 control-label">Courage</label>
        <div class="col-sm-10 col-md-8">       
      ...
      <div class="form-group">
        <label for="response" class="col-sm-2 col-md-4 control-label">Response</label>
        <div class="col-sm-10 col-md-8">       
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <div class="form-group">
        <label for="surface-dirt" class="col-sm-2 col-md-4 control-label">Dirt</label>
        <div class="col-sm-10 col-md-8">
     ...
     <div class="form-group">
      <label for="surface-turf" class="col-sm-2 col-md-4 control-label">Turf</label>
      <div class="col-sm-10 col-md-8">             
        <select name="surface_turf" class="form-control">
         <option></option>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <div class="form-group">
      <label for="leg-type" class="col-sm-2 col-md-4 control-label"> Leg Type</label>
      <div class="col-sm-10 col-md-8">
   ...
   <div class="form-group">
    <label for="neck-height" class="col-sm-2 col-md-4 control-label"> Neck Height</label>
    <div class="col-sm-10 col-md-8">             
 ...
 <div class="form-group">
  <label for="run-style" class="col-sm-2 col-md-4 control-label"> Run Style</label>
  <div class="col-sm-10 col-md-8">             
...
<div class="form-group">
  <label for="bandages" class="col-sm-2 col-md-4 control-label"> Bandages</label>
  <div class="col-sm-10 col-md-8">             
...
<div class="form-group">
  <label for="hood" class="col-sm-2 col-md-4 control-label"> Hood</label>
  <div class="col-sm-10 col-md-8">             
...
<div class="form-group">
  <label for="shadow-roll" class="col-sm-2 col-md-4 control-label"> Shadow Roll</label>
  <div class="col-sm-10 col-md-8">             

...
@section('content')
<div class="page-header"><h1>Add Person <h2><small>Tracking owners, breeders, and hexers</small></h2></h1></div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <label for="racing_colors" class="col-sm-3 control-label">                 
               Racing Colors</label>
               <div class="col-sm-9"> 
                <input name="racing_colors" class="form-control" id="person_racing_colors" placeholder="...">   
              </div>             

   ...
   <div class="panel panel-default">
    ...
    <div class="panel-body">
      <div class="form-group">
        ...
        <div class="col-sm-9">
        <input name="person_name" class="form-control" id="person_name" placeholder="Haubing">              
        </div>             
      </div><!--end username-->       
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">       
          <input name="person_stable_name" class="form-control" id="person_stable_name" placeholder="Shashka Stables">         
        </div>             
      </div><!--end stable name--> 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9"> 
          <input name="person_stable_prefix" class="form-control" id="person_stable_prefix" placeholder="Haubing">   
        </div>             

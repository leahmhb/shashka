   ...
   <div class="col-sm-6">
    <div class="stall-tabs">
      <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation" class=""><a href="#records" aria-controls="records" role="tab" data-toggle="tab">Top 3 Records</a></li>
      ...
      <div role="tabpanel" class="tab-pane" id="records">
       <h2>Top Three Race Records</h2>
       <ol>
        <li>First Place</li>
        <ol>
          <li>
            <span class="text-capitalize"><a href="#">Race Name</a>

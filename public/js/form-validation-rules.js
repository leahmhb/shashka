...
/*  "required,breeder,Please select breeder.",
  "required,hexer,Please select hexer.",*/

/*  "digits_only,distance_max,max distance field may only contain digits.",
"digits_only,distance_min,min distance field may only contain digits.",*/
...
"required,breeding_status,Please select a breeding status.",
"required,grade,Please select a grade.",
/*"required,bandages,Please select a bandages option.",
"required,hood,Please select a hood option.",
"required,shadow_roll,Please select a shadow roll option.",
"required,surface_dirt,Please select a dirt surface option.",
"required,surface_turf,Please select a turf surface option.",

"required,leg_type,Please select a leg type.",
"required,neck_height,Please select a neck height.",
"required,run_style,Please select a run style.",

"required,pos_ability_1,Please select the first positive ability.",
"required,pos_ability_2,Please select the second positive ability.",
"required,neg_ability_1,Please select the first negative ability.",*/

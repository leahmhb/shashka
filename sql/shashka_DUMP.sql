...
--
-- Host: 127.13.0.2:3306
-- Generation Time: Mar 30, 2016 at 08:12 PM
...
CREATE TABLE IF NOT EXISTS `grades` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `grades_grade_unique` (`grade`)
...
CREATE TABLE IF NOT EXISTS `horses` (
  ...
  KEY `horses_call_name_index` (`call_name`)
...
CREATE TABLE IF NOT EXISTS `horses_progeny` (
  ...
  PRIMARY KEY (`id`),
  KEY `horses_progeny_horse_id_index` (`horse_id`),
  KEY `horses_progeny_sire_id_index` (`sire_id`),
  KEY `horses_progeny_dam_id_index` (`dam_id`)
...
CREATE TABLE IF NOT EXISTS `leg_types` (
  ...
  `description` longtext COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `leg_types_type_unique` (`type`)
